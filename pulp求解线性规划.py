...
def main():
    ...
    基建综合产出_假设作战记录溢出 = (
        龙门币综合产出 / 钱书需求比下限 * 作战记录价值
        + (作战记录综合产出 - 龙门币综合产出 / 钱书需求比下限) * 作战记录价值 * 溢出折算系数
        + 龙门币综合产出 * 龙门币价值
        + 信用综合产出 * 信用价值
        + 公开招募刷新综合产出 * 公开招募刷新价值
    )
    基建综合产出_假设龙门币溢出 = (
        作战记录综合产出 * 作战记录价值
        + (作战记录综合产出 * 钱书需求比上限) * 龙门币价值
        + (龙门币综合产出 - 作战记录综合产出 * 钱书需求比上限) * 龙门币价值 * 溢出折算系数
        + 信用综合产出 * 信用价值
        + 公开招募刷新综合产出 * 公开招募刷新价值
    )
    ...
    源石碎片平衡约束条件 = 源石碎片综合产出 >= 0
    合成玉产出约束条件 = 合成玉综合产出 == 每日需求合成玉
    ...
    # 定义线性规划问题
    线性规划问题_假设无溢出: pulp.LpProblem = pulp.LpProblem(sense=pulp.LpMaximize)
    线性规划问题_假设无溢出 += 基建综合产出_假设无溢出
    for 约束条件 in 约束条件列表:
        线性规划问题_假设无溢出 += 约束条件
    线性规划问题_假设无溢出 += 作战记录综合产出 * 钱书需求比下限 <= 龙门币综合产出
    线性规划问题_假设无溢出 += 龙门币综合产出 <= 作战记录综合产出 * 钱书需求比上限

    线性规划问题_假设作战记录溢出: pulp.LpProblem = pulp.LpProblem(sense=pulp.LpMaximize)
    线性规划问题_假设作战记录溢出 += 基建综合产出_假设作战记录溢出
    for 约束条件 in 约束条件列表:
        线性规划问题_假设作战记录溢出 += 约束条件
    线性规划问题_假设作战记录溢出 += 作战记录综合产出 * 钱书需求比下限 >= 龙门币综合产出

    线性规划问题_假设龙门币溢出: pulp.LpProblem = pulp.LpProblem(sense=pulp.LpMaximize)
    线性规划问题_假设龙门币溢出 += 基建综合产出_假设龙门币溢出
    for 约束条件 in 约束条件列表:
        线性规划问题_假设龙门币溢出 += 约束条件
    线性规划问题_假设龙门币溢出 += 作战记录综合产出 * 钱书需求比上限 <= 龙门币综合产出
    ...
    if 求解结果_假设无溢出['基建综合产出_假设无溢出'] > 求解结果_假设作战记录溢出['基建综合产出_假设作战记录溢出']:
        求解结果 = 求解结果_假设无溢出
    elif 求解结果_假设作战记录溢出['基建综合产出_假设作战记录溢出'] > 求解结果_假设龙门币溢出['基建综合产出_假设龙门币溢出']:
        求解结果 = 求解结果_假设作战记录溢出
    else:
        求解结果 = 求解结果_假设龙门币溢出
    ...
    print(f'钱书产出比：{求解结果['龙门币综合产出'] / 求解结果['作战记录综合产出']:.4f}')
    print(f'作战记录综合产出：{求解结果['作战记录综合产出']:.4f}')
    print(f'赤金综合产出：{求解结果['赤金综合产出']:.4f}')
    print(f'龙门币综合产出：{求解结果['龙门币综合产出']:.4f}')
    print(f'源石碎片综合产出：{求解结果['源石碎片综合产出']:.4f}')
    print(f'合成玉综合产出：{求解结果['合成玉综合产出']:.4f}')
