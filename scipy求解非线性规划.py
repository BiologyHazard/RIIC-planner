...
def main():
    ...
    def 基建综合产出(变量):
        平均每日产出作战记录 = 平均每日产出作战记录函数(变量)
        平均每日产出龙门币 = 平均每日产出龙门币函数(变量)
        平均每日产出信用 = 平均每日产出信用函数(变量)
        平均每日产出公开招募刷新 = 平均每日产出公开招募刷新函数(变量)

        作战记录符合钱书比的部分 = min(平均每日产出作战记录, 平均每日产出龙门币 / 钱书需求比下限)
        龙门币符合钱书比的部分 = min(平均每日产出龙门币, 平均每日产出作战记录 * 钱书需求比上限)
        溢出的作战记录 = 平均每日产出作战记录 - 作战记录符合钱书比的部分
    ...
    print(f'钱书产出比：{平均每日产出龙门币函数(结果) / 平均每日产出作战记录函数(结果):.4f}')
    print(f'平均每日产出作战记录：{平均每日产出作战记录函数(结果):.4f}')
